...
- **UI (v0.8)** — three layers, `CX,CY` for the (enlarged) ring are `205,270`, `R_IN=68`/`R_OUT=160` (screen centre is `205,251`; the ring is shifted down `+19`):
